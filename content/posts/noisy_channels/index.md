...
-  From some observations, we can see the timing_ns distribution form three clusters and the power trace forms two clusters. We can visualise the different clusters as: ![alt](distributions.png)
